...
describe('cda_performer unit tests', function () {
    it('sample valid_0', function () {
        var valid = bbm.validator.validateComponent(samples.valid_0, 'cda_performer');
        expect(valid).to.be.true;
    });

    it('sample valid_1', function () {
        var valid = bbm.validator.validateComponent(samples.valid_1, 'cda_performer');
        expect(valid).to.be.true;
    });

    it('sample valid_2', function () {
        var valid = bbm.validator.validateComponent(samples.valid_2, 'cda_performer');
        expect(valid).to.be.true;
    });

    it('sample invalid_0', function () {
        var valid = bbm.validator.validateComponent(samples.invalid_0, 'cda_performer');
